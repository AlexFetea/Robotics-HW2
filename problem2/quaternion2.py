...
class Quaternion:
    ...
    # def euler_angles_ZXY(self):
    #     # Unpack the quaternion
    #     q0, q1, q2, q3 = self.q
    
    #     # Compute Euler angles (Z-X-Y rotation order)
    #     phi = math.atan2(2 * (q1*q2 + q0*q3), 1 - 2 * (q2*q2 + q3*q3))  # Z-axis rotation
    #     theta = math.asin(2 * (q0*q2 - q1*q3))  # X-axis rotation
    #     psi = math.atan2(2 * (q0*q1 + q2*q3), 1 - 2 * (q1*q1 + q2*q2))
